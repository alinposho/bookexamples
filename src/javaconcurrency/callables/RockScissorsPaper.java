package javaconcurrency.callables;
...
public class RockScissorsPaper {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 10; i > 0; i--) {
			...
			System.out.println(payoff(future1.get(),
					future2.get()));
		}
		pool.shutdown();
	...
	public void run() {
		new FutureTask<Integer>(new ThisCallable());
	}
	...
	public class ThisCallable implements Callable<Integer> {
